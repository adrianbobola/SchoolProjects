...
/*                                                                            */
/* Reseni vytvoril(a) a odevzdava: (Adrian Bobola, xbobol00)                  */
/*                                                                            */
/******************************************************************************/
...
void ADC0_Init(void)
{
	...
	ADC0_CFG1 = (ADC_CFG1_ADICLK(0x1) | ADC_CFG1_ADIV(0x3) | ADC_CFG1_MODE(0x0));
	ADC0_SC1A = (ADC_SC1_ADCH(0x6) | ADC_SC1_AIEN(0x1));
...
void ADC0_IRQHandler(void) {
	 float vypocet = ((ADC0_RA * 330.0) / 255.0);
	 float vypocet_d1 = vypocet / 100.0;
	 float vypocet_d2 = 0.0;
	 float vypocet_d3 = vypocet / 100.0;

	 if (vypocet > 300){
		 vypocet_d2 = (vypocet - 300.0) / 10.0;
	 } else if (vypocet > 200){
		 vypocet_d2 = (vypocet - 200.0) / 10.0;
	 } else if (vypocet > 100){
		 vypocet_d2 = (vypocet - 100.0) / 10.0;
	 } else {
		 vypocet_d2 = vypocet / 10.0;
	 }

	 if (vypocet > 330){
		 vypocet_d3 = (vypocet - 330.0);
	 } else if (vypocet > 320){
		 vypocet_d3 = (vypocet - 320.0);
	 } else if (vypocet > 310){
		 vypocet_d3 = (vypocet - 310.0);
	 } else if (vypocet > 300){
		 vypocet_d3 = (vypocet - 300.0);
	 } else if (vypocet > 290){
		 vypocet_d3 = (vypocet - 290.0);
	 } else if (vypocet > 280){
		 vypocet_d3 = (vypocet - 280.0);
	 } else if (vypocet > 270){
		 vypocet_d3 = (vypocet - 270.0);
	 } else if (vypocet > 260){
		 vypocet_d3 = (vypocet - 260.0);
	 } else if (vypocet > 250){
		 vypocet_d3 = (vypocet - 250.0);
	 } else if (vypocet > 240){
		 vypocet_d3 = (vypocet - 240.0);
	 } else if (vypocet > 230){
		 vypocet_d3 = (vypocet - 230.0);
	 } else if (vypocet > 220){
		 vypocet_d3 = (vypocet - 220.0);
	 } else if (vypocet > 210){
		 vypocet_d3 = (vypocet - 210.0);
	 } else if (vypocet > 200){
		 vypocet_d3 = (vypocet - 200.0);
	 } else if (vypocet > 190){
		 vypocet_d3 = (vypocet - 190.0);
	 } else if (vypocet > 180){
		 vypocet_d3 = (vypocet - 180.0);
	 } else if (vypocet > 170){
		 vypocet_d3 = (vypocet - 170.0);
	 } else if (vypocet > 160){
		 vypocet_d3 = (vypocet - 160.0);
	 } else if (vypocet > 150){
		 vypocet_d3 = (vypocet - 150.0);
	 } else if (vypocet > 140){
		 vypocet_d3 = (vypocet - 140.0);
	 } else if (vypocet > 130){
		 vypocet_d3 = (vypocet - 130.0);
	 } else if (vypocet > 120){
		 vypocet_d3 = (vypocet - 120.0);
	 } else if (vypocet > 110){
		 vypocet_d3 = (vypocet - 110.0);
	 } else if (vypocet > 100){
		 vypocet_d3 = (vypocet - 100.0);
	 } else if (vypocet > 90){
		 vypocet_d3 = (vypocet - 90.0);
	 } else if (vypocet > 80){
		 vypocet_d3 = (vypocet - 80.0);
	 } else if (vypocet > 70){
		 vypocet_d3 = (vypocet - 70.0);
	 } else if (vypocet > 60){
		 vypocet_d3 = (vypocet - 60.0);
	 } else if (vypocet > 50){
		 vypocet_d3 = (vypocet - 50.0);
	 } else if (vypocet > 40){
		 vypocet_d3 = (vypocet - 40.0);
	 } else if (vypocet > 30){
		 vypocet_d3 = (vypocet - 30.0);
	 } else if (vypocet > 20){
		 vypocet_d3 = (vypocet - 20.0);
	 } else if (vypocet > 10){
		 vypocet_d3 = (vypocet - 10.0);
	 } else {
		 vypocet_d3 = vypocet;
	 }

	 result[0] = vypocet_d1 + '0';
	 result[1] = '.';
	 result[2] = vypocet_d2 + '0';
	 result[3] = vypocet_d3 + '0';
}
/******************************************************************************/
